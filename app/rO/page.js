              ...
              {showElements.map((showElement, index) => (
                ...
                >
                  ...
                  <p className="leading-relaxed ml-2 mt-1">
                    ...
                    {index === 1 &&
                      "By eliminating impurities and dissolved solids, reverse osmosis can significantly improve the taste, odour, and overall quality of water."}
                    {index === 2 &&
