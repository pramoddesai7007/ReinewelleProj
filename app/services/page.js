      ...
      <div className=" max-w-8xl mx-auto rounded-md mt-16">
        ...
        <section className="relative z-20 mt-28">
          ...
          <div className="px-5">
            ...
            <div className="flex flex-wrap text-center lg:gap-8 md:gap-16 mt-8">
        ...
        <div>
          <section className="text-gray-600 body-font bg-blue-50 mt-16 mb-16">
            <div className="container px-5 py-20 lg:gap-8">
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <p className="leading-relaxed mb-3 text-center">
                        ...
                        make it appropriate for a specific end-use and drinking suitable.
                      </p>
                      <div className="flex items-center flex-wrap ">
                        <a
                          href="waterTreatment"
        ...
        <div>
          <div className=" text-center relative mb-10">
            ...
            <div className="absolute hidden md:hidden lg:block h-full bg-blue-800 w-1 top-0 lg:left-1/2 md:left-52 bottom-0 mt-1"></div>
            <p className="max-w-lg text-center lg:text-left text-gray-900 dark:text-white text-sm mt-1 lg:mt-0 lg:float-right lg:mr-20 md:ml-24 pl-4 pr-4 lg:pl-0 lg:pr-0 md:pl-0 md:pr-0">
